...
echo "     Name: chronis-aic (private)"
echo ""
echo "  2. Connect and push:"
echo "     git remote add origin https://github.com/YOUR_USERNAME/chronis-aic.git"
echo "     git push -u origin main"
echo ""
echo "  3. Add Aditya as collaborator:"
echo "     Repo Settings → Collaborators → Add people → his GitHub username"
echo ""
echo "  4. Run tests:"
echo "     cd hw-track-1-sensors && pytest tests/ -v"
echo ""
